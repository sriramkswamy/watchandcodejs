This is the source of a [Hexo](https://hexo.io) site that follows the [Practical Javascript course](http://watchandcode.com/courses/practical-javascript) at [Watch and code](https://watchandcode.com).
